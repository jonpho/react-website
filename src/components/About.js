      ...
      <section className="section-1">
        <div className="wrap row">
          <div className="small-12 medium-7 columns">
            <h2>Welcome</h2>
            <p>Hello! My name is Jonathan Pho. I'm a Senior Automation Engineer with over 10 years
            ...
            <p>The main point of this site is to update my skills and knowledge of
          ...
          <div className="small-0 medium-4 columns">
            <img className="thumbnail profile-thumbnail" alt="profile image" src={headShot} />
          </div>
        </div>
      </section>
    );
